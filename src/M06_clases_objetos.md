...
%% md prov-30
Este es el momento en el que empezás a **ver** cómo se construye una señal muestreada a partir de una descripción continua. Por ahora lo hacemos a mano con listas y bucles; más adelante, en M07, NumPy te va a permitir hacer lo mismo en una sola línea y con arrays vectorizados.
